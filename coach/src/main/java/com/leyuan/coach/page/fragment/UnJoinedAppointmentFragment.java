...
public class UnJoinedAppointmentFragment extends BaseLazyFragment implements AppointmentViewListener{
    ...
    public void initData() {
        ...
        present.pullToRefreshData(coachId, UN_JOIN);
    }
    ...
    private EndlessRecyclerOnScrollListener onScrollListener = new EndlessRecyclerOnScrollListener(){
        ...
        public void onLoadNextPage(View view) {
            ...
            if (data != null && data.size() >= pageSize) {
                present.requestMoreData(recyclerView,coachId,UN_JOIN,pageSize,currPage);
            }
        }
    };
